    ...
    for j in range(0,len(B1Q1_list)):
        for k in range(0,len(B2Q3_list)):
            for l in range(0,len(X_list)):
                formula=A_list[i]+'2'+B2Q3_list[k]+B1Q1_list[j]+X_list[l]+'6'
                #print(formula)
                ...
                B1Q1_list_final.append(B2Q3_list[k])
                ...
                B2Q3_list_final.append(B1Q1_list[j])                
...
with open('result_A2_B1Q3_B2Q1_X6.csv', 'w') as myfile:
